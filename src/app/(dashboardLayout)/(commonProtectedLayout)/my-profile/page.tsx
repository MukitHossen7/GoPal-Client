...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!profile) {
    return {
      title: "My Profile | GoPal",
      description: "Manage your GoPal profile and account settings.",
    };
  }

  return {
    title: `${profile.name} - My Profile | GoPal Dashboard`,
    description: `Welcome back, ${profile.name}. Manage your travel plans, update your profile, and check your membership status on GoPal.`,
    robots: {
      index: false,
      follow: true,
    },
          ...
          <div className="absolute -bottom-24 left-4 sm:left-8 md:left-12 flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-6 z-10 w-full md:w-auto">
            ...
            <div className="text-center md:text-left mb-2 md:mb-6 space-y-1.5 flex-1">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 break-words max-w-[300px] md:max-w-[500px]">
                  {profile?.name}
                </h1>
                <Badge
