  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {accessToken && authData.data?.email ? (
              ...
              <div className="flex items-center gap-3">
                <Link href="/login">
                  <button className="text-sm font-semibold px-5 py-2 hover:text-primary transition-colors">
                    Login
                  </button>
                </Link>
                <Link href="/register">
                  <Button className="bg-primary hover:bg-primary/90 text-white rounded-full px-7 shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95">
                    Sign Up
                  </Button>
                </Link>
              </div>
        ...
        {menuOpen && (
          <div className="lg:hidden absolute left-0 right-0 top-[100%] bg-background border-b shadow-xl p-4 space-y-4 animate-in slide-in-from-top-2 duration-300">
