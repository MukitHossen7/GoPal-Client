...
const TravelLoader = ({ fullScreen = true }: TravelLoaderProps) => {
  ...
  return (
    <div className={containerClasses}>
      {/* =======================================================
          1. MOBILE VIEW (Visible on sm & below)
          Style: Minimalist Infinity Flight
         ======================================================= */}
      ...
      {/* =======================================================
          2. TABLET VIEW (Visible on md only)
          Style: Radar / Location Search
         ======================================================= */}
      ...
      <div className="hidden lg:block">
        <div className="relative w-40 h-40 flex items-center justify-center">
          ...
          <motion.div
            className="absolute w-36 h-36 border-[1px] border-primary/20 rounded-full"
            animate={{ rotate: -360 }}
