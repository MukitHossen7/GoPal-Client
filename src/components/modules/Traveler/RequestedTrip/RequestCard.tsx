...
export const RequestCard = ({ request, index }: RequestCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="group flex flex-col lg:flex-row overflow-hidden border-border/60 bg-card shadow-sm transition-all hover:shadow-lg hover:border-primary/30 h-auto lg:h-[240px]">
